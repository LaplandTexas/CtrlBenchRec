...
if __name__ == '__main__':
    ...
    # one_shot()
    # few_shot()
    # epoch_200_debate_evaluation(19)
    # epoch_200_base_evaluation(9)
    # epoch_200_evaluation(19)
    # task3_evaluation(39)
    # evaluate_amazon("../generated_user_profile/behavior_length_6_amazon/test_1/user_28_profile_0_39.json",
    #                 "../generated_user_profile/behavior_length_6_amazon/test_1/user_28_profile_0_0.json")
    # evaluate_amazon("../generated_user_profile/behavior_length_6_amazon/base/user_100_profile_0_39.json",
    #                 "../generated_user_profile/behavior_length_6_amazon/user_100_profile.json")
    # evaluate_amazon("../generated_user_profile/behavior_length_6_amazon/base1/user_100_profile_0_19.json",
    #                 "../generated_user_profile/behavior_length_6_amazon/base1/user_100_profile.json")
    # evaluate_amazon("../generated_user_profile/behavior_length_6_amazon/test_debate/user_28_profile_0_19.json",
    #                 "../generated_user_profile/behavior_length_6_amazon/test_debate/user_28_profile.json")
    # evaluate_amazon("../generated_user_profile/behavior_length_6_amazon/test_debate/user_28_profile_0_39.json",
    #                 "../generated_user_profile/behavior_length_6_amazon/test_debate/user_28_profile.json")
    # AmazonLoader.get_count_in_target_tag_list(target_tag_list)
    # bge_amazon_base_evaluation(9)
    # bge_amazon_test_evaluation(19)
    # bge_ml1m_base_evaluation(19)
    # bge_ml1m_test_evaluation(19)
    # narm_ml1m_test_evaluation(4)
    # narm_ml1m_test_evaluation(9)
    # narm_ml1m_test_evaluation(14)
    # narm_ml1m_base_evaluation(19)
    task3_evaluation(4)
    # task2_l1_evaluation()
    # task2_l2_evaluation()
    # task2_l3_evaluation()
