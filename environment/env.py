        ...
        if isinstance(platform, DefaultPlatformType):
            ...
            if platform == DefaultPlatformType.TWITTER:
                ...
                self.platform = Platform(
                    ...
                    refresh_rec_post_count=max_rec_len,
                    max_rec_post_len=max_rec_len,
                    following_post_count=0,
                )
                self.platform_type = DefaultPlatformType.TWITTER_BGE
            ...
            elif platform == DefaultPlatformType.MOVIE:
                self.channel = Channel()
                self.platform = Platform(
                    db_path=database_path,
                    channel=self.channel,
            ...
            elif platform == DefaultPlatformType.TWITTER_BGE:
                self.channel = Channel()
                self.platform = Platform(
                    db_path=database_path,
                    channel=self.channel,
