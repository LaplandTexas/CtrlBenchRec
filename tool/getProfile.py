...
def movie_len_user():
    movieLenLoader = movieLenLoader.MovieLenLoader()
    ...
    with open("..\\generated_user_profile\\behavior_length_12\\user_100_profile.json", "w") as file:
