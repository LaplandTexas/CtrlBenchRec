...
def process_batch(model: AutoModel, tokenizer: AutoTokenizer,
    ...
    print(f"oasis.social_platform.process_recsys_posts.process_batch:{outputs}")
...
def generate_post_vector(model: AutoModel, tokenizer: AutoTokenizer, texts,
    ...
    print(f"oasis.social_platform.process_recsys_posts.generate_post_vector:{all_outputs_tensor.shape}")
